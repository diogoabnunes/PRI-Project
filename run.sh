...
curl -X POST -H 'Content-type:application/csv' --data-binary @C:\\Users\\'Diogo Nunes'\\'OneDrive - Universidade do Porto'\\FEUP\\PRI\\Formula1\\documentos_resultado\\seasons_joined.csv localhost:8983/solr/races_default/update?commit=true
curl -X POST -H 'Content-type:application/csv' --data-binary @C:\\Users\\'Diogo Nunes'\\'OneDrive - Universidade do Porto'\\FEUP\\PRI\\Formula1\\documentos_resultado\\drivers_joined.csv localhost:8983/solr/races_default/update?commit=true
curl -X POST -H 'Content-type:application/csv' --data-binary @C:\\Users\\'Diogo Nunes'\\'OneDrive - Universidade do Porto'\\FEUP\\PRI\\Formula1\\documentos_resultado\\constructors_joined.csv localhost:8983/solr/races_default/update?commit=true
curl -X POST -H 'Content-type:application/csv' --data-binary @C:\\Users\\'Diogo Nunes'\\'OneDrive - Universidade do Porto'\\FEUP\\PRI\\Formula1\\documentos_resultado\\circuits_joined.csv localhost:8983/solr/races_default/update?commit=true
