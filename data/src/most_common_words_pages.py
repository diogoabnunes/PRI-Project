...
file = open("../documentos_resultado/pages_text.csv",encoding="utf8")
reader = csv.reader(file)
lines= len(list(reader))

# Load in the dataframe
df = pd.read_csv("../documentos_resultado/pages_text.csv")
...
wordcloud_text.to_file("../docs/common_words/pages.png")