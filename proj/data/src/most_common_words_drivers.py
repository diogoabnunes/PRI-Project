...
file = open("../documentos_resultado/drivers_joined.csv",encoding="utf8")
reader = csv.reader(file)
lines= len(list(reader))

# Load in the dataframe
df = pd.read_csv("../documentos_resultado/drivers_joined.csv")
...
wordcloud_text.to_file("../docs/common_words/drivers.png")